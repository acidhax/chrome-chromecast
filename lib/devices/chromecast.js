...
ChromeCast.prototype = Object.create(Device.prototype);
...
ChromeCast.prototype.running = function(cb) {
	...
	request.end(function(err, res) {
		...
		var parsed = XML2JSON.parse(res.text, {object: true});
		var app = {
...
ChromeCastApp.prototype = Object.create(App.prototype);
...
ChromeCastApp.prototype.connect = function(cb) {
	...
	this.getConnection(function(err, sockUrl) {
		...
		that.socket = new WebSocket(sockUrl);
